...
const NAV_GROUPS = [
  ...
  { label: 'Multimodal', items: [
    { id: 'voice', label: 'Voice Chat', icon: 'mic', href: '#voice' },
    { id: 'files', label: 'Files', icon: 'folder', href: '#files' },
    { id: 'images', label: 'Image Gen', icon: 'image', href: '#images' },
    { id: 'search', label: 'Web Search', icon: 'search', href: '#search' },
...
search: '<circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line>',
  rocket: '<path d="M4.5 16.5c-1.5 1.5-3 3.5-3 5.5A5.5 5.5 0 0 0 10.5 23H13a4 4 0 0 0 4-4V9.5a2.5 2.5 0 0 0-5 0v5a2.5 2.5 0 0 1-5 0V5a5 5 0 0 1 10 0v5a3.5 3.5 0 0 1-7 0v-1.5c0-.5.5-1 1-1h2c.5 0 1 .5 1 1v1.5c0 1.5 1.5 3 3.5 3z"></path>',
  ...
  mic: '<path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3v1a3 3 0 0 0 3 3v1a3 3 0 0 0 3-3 3-3 3-3 3H9a3 3 0 0 0-3 3v1a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="22"></line><line x1="8" y1="23" x2="16" y2="23"></line>',
  folder: '<path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path>',
  image: '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline>',
  search: '<circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line>',
  camera: '<path d="M23 19a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2z"></path><circle cx="12" cy="12" r="4"></circle><path d="M12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10z"></path>',
  mic: '<path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3v1a3 3 0 0 0 3 3v1a3 3 0 0 0 3-3 3-3 3-3 3H9a3 3 0 0 0-3 3v1a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="22"></line><line x1="8" y1="23" x2="16" y2="23"></line>',
};
